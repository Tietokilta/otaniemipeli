import { Pixeloid, PixeloidMono, PixeloidBold } from "./src/utils/get_fonts.ts";
...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ["var(--font-pixel)", ...Pixeloid],
        mono: ["var(--font-mono)", ...PixeloidMono],
        bold: ["var(--font-bold)", ...PixeloidBold],
      },
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
